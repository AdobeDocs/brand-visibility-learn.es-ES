...
Si es redactor técnico, administrador de programa o desarrollador del equipo de producto para una solución de Adobe Experience Cloud, y su trabajo consiste en contribuir a artículos técnicos o en crearlos, use [repositorio privado](https://git.corp.adobe.com/AdobeDocs).
